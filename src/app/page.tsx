          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I&apos;am tired of the same old boring case and vulnerable.
                  However, this case feels durable and I even got a compliment
                  on the design. Had the case for three and a half months now
                  and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is crystal clear
                  </span>
                  , never had a problem on the case comparing my old case. The
                  image started fading into yellow-ish color after a couple
                  weeks. Really recommended 👍"
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  I dropped my phone a week ago and luckily it wasn&apos;t
                  damaged. It&apos;s really worth to buy cuz you don't really
                  know when bad things happen.{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    The detail is superb
                  </span>
                  , I will recommend to my fellow definitely..."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img
